...
public class NavigatorData
{
    ...
    {
        timesteps = new List<NavigatorTimestepData>();
    }
}

[System.Serializable]
public class NavigatorTimestepData
{
    public float time;
    public int seed;
    public int speed;
    ...
    public NavigatorTimestepData (float time, int seed, int speed, int rotationSpeed, Vector2 cameraPosition, Vector3 headPosition, Vector2 eyePosition)
    {
        this.time = time;
        this.seed = seed;
        this.speed = speed;
